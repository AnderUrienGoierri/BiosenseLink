...
```mermaid
graph TD
    Root[docs/INDEX.md] --> ESP[Castellano / Español]
    ESP --> ESP_Index[docs/esp/INDEX.md]
    
    Root --> EUS[Euskara / Vasco]
    EUS --> EUS_Index[docs/eus/AURKIBIDEA.md]

    style Root fill:#0284c7,stroke:#0369a1,stroke-width:2px,color:#fff
    style ESP fill:#0d9488,stroke:#0f766e,color:#fff
    style EUS fill:#e11d48,stroke:#be123c,color:#fff
```
